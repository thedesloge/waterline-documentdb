...
```sh
$ npm install waterline-documentdb
```

[![NPM](https://nodei.co/npm/waterline-documentdb.png?downloads=true&stars=true)](https://nodei.co/npm/waterline-documentdb/)
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8acf2fc2ca0aca8a3018e355ad776ed7 "githalytics.com")](http://githalytics.com/balderdashy/waterline-documentdb/FAQ.md)
